<template>
  <div class="canvas-motion">
    <canvas id="canvas" style="position:absolute; top: 0; right: 0;"></canvas>
...
<script>
    export default {
        ...
        mounted:function(){
            ...
            var textSet = [
              {text:"HI_LADIES", sphereRadius:140, sphereSpace:80, unitTime:100, time:1000},
              {text:"THIS_IS", sphereRadius:120, sphereSpace:70, unitTime:120, time:4000},
              {text:"BILLY", sphereRadius:120, sphereSpace:70, unitTime:50, time:2000},
              {text:"ELGERON", sphereRadius:120, sphereSpace:70, unitTime:100, time:4000},
              {text:"BASED_ON", sphereRadius:100, sphereSpace:60, unitTime:100, time:3000},
              {text:"IMAGINATION", sphereRadius:140, sphereSpace:80, unitTime:100, time:2000},
              {text:"@@@@@@@@", sphereRadius:60 + Math.random()*60, sphereSpace:200, unitTime:100, time:4000},
              {text:"SOUND", sphereRadius:120, sphereSpace:70, unitTime:100, time:2000},
              {text:"AND", sphereRadius:100, sphereSpace:60, unitTime:150, time:3500},
              {text:"MOVES", sphereRadius:120, sphereSpace:70, unitTime:50, time:2000},
              {text:"?", sphereRadius:100, sphereSpace:60, unitTime:100, time:2500},
